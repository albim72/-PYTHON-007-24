...
#klasa implementująca Protocol DataProcessor dla operacji na liczbach
class NumberProcessor:
    def process(self,data:List[Any])->List[Any]:
        return [item*2 for item in data if isinstance(item,int) or isinstance(item,float)]

#klasa implementująca Protocol DataProcessor dla operacji na ciągach znaków
...
data_to_process = [1,2,3,4,5.5,'hej','zielony','a1']
